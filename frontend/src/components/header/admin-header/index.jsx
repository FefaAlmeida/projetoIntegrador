   ...
   <div className="container-fluid px-5 d-flex flex-wrap justify-content-between align-items-center py-3">
    ...
    <ul className="nav nav-pills align-items-center gap-3">
     <li className="nav-item">
      <a href="/user/admin" className="nav-link text-white">
     ...
     <li className="nav-item">
      <a href="/user/admin/users" className="nav-link text-white">
     ...
     <li className="nav-item">
      <a href="/user/admin/orders" className="nav-link text-white">
     ...
     <li className="nav-item dropdown">
      ...
      >
       ...
       <li>
        <a className="dropdown-item text-white py-2" href="/user/preferences">
